...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/12/22 12:39:07 by mdaboc            #+#    #+#              #
#    Updated: 2017/12/22 12:50:16 by mdaboc           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_atoi.c ft_bzero.c ft_isalnum.c \
	   ...
	   ft_strequ.c ft_striteri.c ft_strjoin.c \
	   ...
	   ft_tolower.c ft_toupper.c ft_memdel.c \
	   ft_striter.c
